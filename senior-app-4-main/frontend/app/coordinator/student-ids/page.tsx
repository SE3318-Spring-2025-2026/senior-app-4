...
function UploadCard() {
  ...
  const handleUpload = async () => {
    ...
    try {
      // Eskiden /api/v1/students/ids/upload vardı, v1 next.js ile uyumluluk için kaldırıldı.
      const res = await fetch("/api/students/ids/upload", { method: "POST", body: formData });
