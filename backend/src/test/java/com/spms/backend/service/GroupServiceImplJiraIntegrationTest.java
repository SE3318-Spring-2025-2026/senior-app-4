...
@BeforeEach
    ...
    void bindJiraIntegrationSucceedsForLeaderWhenValidationPasses() {
        ...
        JiraBindingRequest request = new JiraBindingRequest("https://team.atlassian.net", "test@example.com", "api-key", "ALPHA");
    ...
    void bindJiraIntegrationReturns400WhenValidationFails() {
        Group group = groupWithLeader(10L, 100L);
        JiraBindingRequest request = new JiraBindingRequest("https://team.atlassian.net", "test@example.com", null, "ALPHA");
    ...
    void getJiraIntegrationReturnsNotConnectedWhenIntegrationMissing() {
        ...
        assertThrows(NotFoundException.class, () -> groupService.getJiraIntegration(10L));
    }
