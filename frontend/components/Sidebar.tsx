    ...
    <aside className="w-64 border-r border-white/5 flex flex-col shrink-0 bg-gray-950">
      ...
      <nav className="flex-1 px-3 py-4 space-y-1">
        ...
        <NavItem
          ...
          href="/dashboard"
          icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 12l9-9 9 9M5 10v10a1 1 0 001 1h3a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1h3a1 1 0 001-1V10" /></svg>}
        />

        {user.role === "student" && (
          <>
            <p className="text-xs font-medium text-gray-600 px-3 mt-4 mb-2 uppercase tracking-widest">
              Student
            </p>
            ...
            <NavItem
              ...
              href="/grades"
              icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6h9.75M10.5 12h9.75M10.5 18h9.75M3.75 6h2.25M3.75 12h2.25M3.75 18h2.25" /></svg>}
            />
            <NavItem
              label="Committees"
        ...
        {user.role === "coordinator" && (
          <>
            <p className="text-xs font-medium text-gray-600 px-3 mt-4 mb-2 uppercase tracking-widest">Management</p>
            <NavItem
              label="Student IDs"
              active={activePage === "student-ids"}
              href="/coordinator/student-ids"
            ...
            <NavItem
              label="System Alerts"
              active={activePage === "system-alerts"}
            ...
            <NavItem
              ...
              active={activePage === "advisor-override"}
              href="/coordinator/advisor-override"
            ...
            <p className="text-xs font-medium text-gray-600 px-3 mt-4 mb-2 uppercase tracking-widest">Grading</p>
            <NavItem
              label="Rubrics"
              active={activePage === "rubrics"}
            ...
            <NavItem
              label="Final Grading"
              active={activePage === "final-grading"}
              href="/coordinator/final-grading"
              icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6h9.75M10.5 12h9.75M10.5 18h9.75M3.75 6h2.25M3.75 12h2.25M3.75 18h2.25" /></svg>}
            />
            <NavItem
              label="Grades"
              active={activePage === "coordinator-grades"}
            ...
            />
            <p className="text-xs font-medium text-gray-600 px-3 mt-4 mb-2 uppercase tracking-widest">AI</p>
            <NavItem
              label="AI Validation"
              active={activePage === "ai-validation"}
              href="/coordinator/ai-validation/config"
              icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z" /></svg>}
            />
            <NavItem
              label="Validation Sprints"
              active={activePage === "ai-validation-sprints"}
              href="/coordinator/ai-validation/sprints"
              icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M5.25 5.653c0-.856.917-1.398 1.667-.986l11.54 6.347a1.125 1.125 0 010 1.972l-11.54 6.347a1.125 1.125 0 01-1.667-.986V5.653z" /></svg>}
            />
          </>
        )}
        ...
        {user.role === "professor" && (
          <>
            ...
            <NavItem
              ...
              active={activePage === "pending-requests"}
              href="/professor/pending-requests"
              icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08M6.75 12h.008v.008H6.75V12zm0 3h.008v.008H6.75V15zm0 3h.008v.008H6.75V18z" /></svg>}
              badge
            />
            <NavItem
            ...
            <NavItem
              ...
              active={activePage === "committee-groups"}
              href="/professor/committee-groups"
...
function NavItem({ icon, label, active = false, href, badge = false }: {
  icon: React.ReactNode; label: string; active?: boolean; href: string; badge?: boolean;
}) {
  return (
    <Link href={href} className={`flex items-center gap-3 px-3 py-2.5 rounded-lg cursor-pointer transition-all ${active ? "bg-blue-600 text-white" : "text-gray-400 hover:text-white hover:bg-white/5"}`}>
      <span className="w-5 h-5 flex items-center justify-center">{icon}</span>
      <span className="text-sm font-medium flex-1">{label}</span>
      {badge && !active && <span className="w-2 h-2 rounded-full bg-red-500 animate-pulse" />}
    </Link>
  );
}
